      ...
      <div className="max-w-5xl mx-auto px-3 sm:px-6 py-2.5 sm:py-3 flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2 sm:gap-3 min-w-0">
          ...
          <button
            ...
            onClick={onBack}
            className={`flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-xl border text-xs sm:text-sm font-bold transition active:scale-95 flex-shrink-0 cursor-pointer ${
              isSecondaryScreen
        ...
        <div className="flex items-center gap-1.5 sm:gap-2">
          ...
          {isAudioPlaying && (
            <button
              ...
              onClick={onStopAudio}
              className="flex items-center gap-1 px-2.5 py-1.5 rounded-lg bg-rose-50 dark:bg-rose-950/60 text-rose-600 dark:text-rose-400 border border-rose-200 dark:border-rose-800 text-xs font-medium animate-pulse cursor-pointer"
              title="Stop speech"
            >
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 sm:py-2 rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-slate-950 font-semibold text-xs sm:text-sm shadow-sm transition active:scale-95 cursor-pointer"
          ...
          <button
            ...
            className="hidden sm:flex relative p-2 sm:px-3 sm:py-2 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-100/80 dark:bg-slate-800/80 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 text-xs sm:text-sm font-medium transition active:scale-95 items-center gap-1.5 cursor-pointer"
          ...
          <button
            ...
            className="p-2 sm:p-2 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-100/80 dark:bg-slate-800/80 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 transition active:scale-95 cursor-pointer"
          ...
          <div className="relative" ref={menuRef}>
            <button
              ...
              className={`p-2 sm:p-2.5 rounded-xl border transition active:scale-95 cursor-pointer ${
                isMenuOpen
            ...
            {isMenuOpen && (
              ...
              >
                ...
                <button
                  ...
                  className="w-full px-3.5 py-2 text-left text-xs sm:text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800/80 flex items-center gap-2.5 transition cursor-pointer"
                >
                ...
                <button
                  ...
                  className="w-full px-3.5 py-2 text-left text-xs sm:text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800/80 flex items-center justify-between transition cursor-pointer"
                >
                ...
                {/* 4. REAL ANDROID APK DOWNLOAD OPTION */}
                <button
                  id="menu-item-download-apk"
                  onClick={() => {
                    setIsMenuOpen(false);
                    if (isApkConfigured && onDownloadApk) {
                      onDownloadApk();
                    } else {
                      onOpenSettings();
                    }
                  }}
                  className="w-full px-3.5 py-2 text-left text-xs sm:text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800/80 flex items-center justify-between gap-2.5 transition cursor-pointer"
                  title={isApkConfigured ? "Download APK" : "APK download is not available yet."}
                >
                  <div className="flex items-center gap-2.5">
                ...
                {/* 5. SEPARATE BROWSER PWA INSTALL OPTION (Only when real browser prompt is active) */}
                {onInstallApp && canInstall && !isInstalled && (
                  <button
                    id="menu-item-install-web-app"
                    onClick={() => {
                      setIsMenuOpen(false);
                      onInstallApp();
                    }}
